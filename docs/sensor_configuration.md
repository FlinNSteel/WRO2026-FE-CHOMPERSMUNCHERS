...
​Hue: Identifies the actual color spectrum, good for differenciating between the greens and reds and blues.
​Saturation: Helps filter out white and grey surfaces, great for identifying color in a dull background.
