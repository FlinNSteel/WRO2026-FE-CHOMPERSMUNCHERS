...
> Disclaimer! The name for "AmIGayQuiz" wasn't made with any intent on harm or malice, the name was selected as the function has an almost identical kind of logic to quizes posted on sites like Buzzfeed which usually had the question "Am I gay". This name also helped differenciate it fromn its "girar" counterpart as it did a completely different function but could've had a similar name which could've led to confusion.
