...
ROT_TIME_MIN = 3300      # Milisegundos mínimos entre giros
MAX_VUELTA = 4
...
def girar(diferencia, med_izq, med_der):
    ...
    steering.run_target(1000, angulo_giro_motor, wait=False)
    ...
    if robot_state["giro_direc"] == 1:
        ...
        while yaw_actual > nuevo_objetivo -2 :
            yaw_actual = hub.imu.heading()
            wait(5)
    else:
